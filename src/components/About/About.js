    ...
    <div className="about">
        <div className="about-overlay">
            <div className="about-info">
                ...
                <h1 className="about-name"><a href="mailto:brentholmesahrens@gmail.com" target="_blank" rel="noopener noreferrer">Brent Ahrens</a></h1>
                <h2 className="about-title">Front End Web Developer</h2>
                <h4 className="about-skills">React | Vue | Javascript | CSS3 | SASS | CSS Grid | FlexBox | HTML5 | RESTful APIs | BEM | Github | Node.js | NPM | SEO | Wordpress | Squarespace | Wagtail | Google Analytics | Gatsby | Command Line | CRUD</h4>
